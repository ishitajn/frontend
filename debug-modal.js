...
function renderAnalysisView() {
    ...
    const lastMessage = analysis.lastMessageAnalysis || {};
    ...
    return `
        ...
        <div class="card-subheader">Overall State</div>
        <table class="payload-table">
            <tr><td>Conversation State</td><td>${createSelect('analysis-state', 'conversationAnalysis.state', CONVERSATION_STATES, analysis.state)}</td></tr>
            <tr><td>Suppress Greeting?</td><td>${createCheckbox('analysis-suppressGreeting', 'conversationAnalysis.suppressGreeting', analysis.suppressGreeting)}</td></tr>
        </table>

        <div class="card-subheader">Last Message Subtext</div>
        <table class="payload-table">
            <tr><td>Is Direct Question?</td><td>${createCheckbox('subtext-isDirectQuestion', 'conversationAnalysis.lastMessageAnalysis.isDirectQuestion', lastMessage.isDirectQuestion)}</td></tr>
            <tr><td>Is Low Effort?</td><td>${createCheckbox('subtext-isLowEffort', 'conversationAnalysis.lastMessageAnalysis.isLowEffort', lastMessage.isLowEffort)}</td></tr>
            <tr><td>Is Sarcastic?</td><td>${createCheckbox('subtext-isSarcastic', 'conversationAnalysis.lastMessageAnalysis.isSarcastic', lastMessage.isSarcastic)}</td></tr>
            <tr><td>Valence</td><td>${createSlider('subtext-valence', 'conversationAnalysis.lastMessageAnalysis.valence', lastMessage.valence, -1, 1, 0.1)}</td></tr>
            <tr><td>Arousal</td><td>${createSlider('subtext-arousal', 'conversationAnalysis.lastMessageAnalysis.arousal', lastMessage.arousal, -1, 1, 0.1)}</td></tr>
            <tr><td>Intents</td><td>${createMultiSelect('subtext-intents', 'conversationAnalysis.lastMessageAnalysis.intents', INTENT_OPTIONS, lastMessage.intents)}</td></tr>
        </table>
        ...
        <table class="payload-table">
            ...
            <tr><td>Inside Jokes</td><td>${createTextarea('memory-insideJokes', 'conversationAnalysis.memory.insideJokes', getArrayAsText(memory.insideJokes))}</td></tr>
            <tr><td>Avoided Topics</td><td>${createTextarea('memory-avoidedTopics', 'conversationAnalysis.memory.avoidedTopics', getArrayAsText(memory.avoidedTopics))}</td></tr>
            <tr><td>Question History</td><td>${createTextarea('memory-questionHistory', 'conversationAnalysis.memory.questionHistory', getArrayAsText(memory.questionHistory))}</td></tr>
        </table>
